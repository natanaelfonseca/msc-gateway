package br.com.treinamento.gateway.config;
...
import br.com.treinamento.gateway.filters.Oauth2ClientContextFilterWithPath;
...
public class AppConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception { // @formatter:off
        http.csrf().disable()
            .authorizeRequests()
            .antMatchers("/api/authserver/**", "/login").permitAll()
